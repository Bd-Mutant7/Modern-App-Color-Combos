...
<div align="center">
  ...
  [![Immersive](https://img.shields.io/badge/Immersive-Shopping-D4AF37?style=flat-square)]()
  
  ---
  
  | [🏠 E-commerce Home](../README.md) | [🎨 Primary](./primary-palette.md) | [💎 Luxury](./luxury-style.md) | [📱 Examples](./examples/) |
  |:---:|:---:|:---:|:---:|
...
|-------|-----|----------|-------|---------|
| Rich Black | `#0A0A0A` | #FFF9F0 | Background | ████ |
| Dark Surface | `#1A1A1A` | #FFFFFF | Cards | ████ |
| Warm Accent | `#FF8C42` | #FF6B4A | CTA buttons | ████ |
| Soft White | `#F5F5F5` | #333333 | Text | ████ |
| Muted Gold | `#B59700` | #D4AF37 | Sale indicators | ████ |
