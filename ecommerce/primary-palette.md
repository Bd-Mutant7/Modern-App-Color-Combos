# 🎨 E-commerce App - Primary Palette
...
<div align="center">
  ...
  | [🏠 E-commerce Home](../README.md) | [🌙 Dark Mode](./dark-mode.md) | [💎 Luxury Style](./luxury-style.md) | [📱 Examples](./examples/) |
  |:---:|:---:|:---:|:---:|
...
|------------|-----|-----|-------|---------|
| Deep Teal | `#008080` | `hsl(180, 100%, 25%)` | Trust, security | ████ |
| Persimmon | `#FF6B4A` | `hsl(14, 100%, 64%)` | Add to cart, buy now | ████ |
| Warm White | `#FFF9F0` | `hsl(40, 100%, 97%)` | Backgrounds | ████ |
| Charcoal | `#333333` | `hsl(0, 0%, 20%)` | Product text | ████ |
| Gold | `#D4AF37` | `hsl(46, 65%, 52%)` | Sales, premium | ████ |
| Success Green | `#00A86B` | `hsl(156, 100%, 33%)` | In stock | ████ |
